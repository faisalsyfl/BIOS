            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="#pablo">Dashboard Monitoring Layanan BLU</a>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                <div class="card-header card-header-success card-header-icon">
                                    ...
                                    <p class="card-category">Inspeksi Teknik</p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                <div class="card-header card-header-danger card-header-icon">
                                    ...
                                    <p class="card-category">Sertifikasi</p>
                        ...
                        <div class="col-lg-3 col-md-6 col-md-6">
                            <div class="card card-chart">
                                <div class="card-header card-header-warning">
                                    <div class="ct-chart" id="pengujianChart"></div>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Yearly Data</h4>
                                    <p class="card-category">
                                        <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span> Meningkat dari tahun sebelumnya.</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                        ...
                        <div class="col-lg-3 col-md-6 col-md-6">
                            <div class="card card-chart">
                                <div class="card-header card-header-success">
                                    <div class="ct-chart" id="inspeksiChart"></div>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Yearly Data</h4>
                                    <p class="card-category">
                        ...
                        <div class="col-lg-3 col-md-6 col-md-6">
                            <div class="card card-chart">
                                <div class="card-header card-header-danger">
                                    <div class="ct-chart" id="sertifikasiChart"></div>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Yearly Data</h4>
                                    <p class="card-category">
                        ...
                        <div class="col-lg-3 col-md-6 col-md-6">
                            <div class="card card-chart">
                                <div class="card-header card-header-info">
                                    <div class="ct-chart" id="pelatihanChart"></div>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Yearly Data</h4>
                                    <p class="card-category">
